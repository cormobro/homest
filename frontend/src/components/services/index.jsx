    ...
    <div className="services">
        ...
        <div className="services__statusQuo">
            <div className="services__statusQuo__item1">
                <h3 className="services__statusquo__item__title">Etat des lieux locatifs d'entrée</h3>
                <ul>
                    <li>Constat réalisé par le bailleur et le locataire permettant de comparer le logement lors de l'entrée dans les lieux et lors de la sortie (Etat des lieux de sortie).</li>
                    <li>A réaliser au plus tard à la fin du premier mois d'occupation par le nouveau locataire.
                        Il est même préférable de le faire avant l'emménagement ( cela permet de mieux évaluer les dommages et d'éviter d'oublier les dégâts occasionnés lors du déménagement ).
                    </li>
            ...
            <div className="services__statusQuo__item2">
                <h3 className="services__statusquo__item__title">Etat des lieux locatifs de sortie</h3>
                <ul>
